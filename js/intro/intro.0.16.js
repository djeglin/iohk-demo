...
function io_intro_gui(sec){
	...
	if(sec == 0){
		...
		jQuery(".intro_nav .colors .swatches").each(function(index){
			jQuery(this).append(io_color_swatches(index,8));
		});
...
intro_gui_set[1] =  '<div class="col col-lg-14">\
						<div class="palette zoom">\
							<b>Zoom</b>\
							<div id="io_intro_zoom"></div>\
						</div>\
						<div class="palette distance">\
							<div class="btn-group dropup">\
								...
								<ul class="dropdown-menu">\
									<li><a id="" type="button" class="btn btn-default btn-sm rounded" href="javascript:;">1</a></li>\
								</ul>\
							</div>\
						</div>\
