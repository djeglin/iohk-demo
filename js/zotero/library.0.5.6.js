...
var library_item_tools = function(){
	...
	<a href="javascript:window.history.back()" class="btn btn-default"><em class="fa fa-chevron-left"></em>&nbsp; Back </a>\
	';
	return out;
}
...
function io_zotero_item_details(dataload) {
	...
	if(io_zotero_layout == 'item'){
		out += '<h1 class="margint0"><a href="'+dataload.data.url+'" target="_blank">'+dataload.data.title+' <sup><em class="fa fa-external-link"></em></sup></a></h1>';
	}else{
    ...
    '+ISBN+'\
    '+abstractNote+'\
    <div class="row buttons"><div class="col-sm-12 col-xs-12"><a class="btn btn-default btn-block rounded" href="#'+dataload.key+'">Read more &nbsp;<em class="fa fa-chevron-right"></em></a></div><div class="col-sm-12 col-xs-12">'+url+'</div></div>\
	';
	return out;
}
