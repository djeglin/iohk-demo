...
function io_zotero_item_details(dataload) {
	...
	if(io_zotero_layout == 'item'){
		out += '<a href="javascript:io_zotero_item_back_button()" class="back rounded"><em class="fa fa-chevron-left"></em><span>'+iolab_back+'</span></a> <h1 class="margint0"> <a href="'+dataload.data.url+'" target="_blank">'+dataload.data.title+' <sup><em class="fa fa-external-link"></em></sup></a></h1>';
	}else{
