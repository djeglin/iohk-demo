...
function io_zotero_item_details(dataload) {
    ...
    '+ISBN+'\
    '+abstractNote+'\
    <div class="row buttons"><div class="col-sm-14 col-xs-14 pdr0 nomobile"><a class="btn btn-default btn-block rounded" href="#'+dataload.key+'">Read more &nbsp;<em class="fa fa-chevron-right"></em></a></div><div class="col-sm-10 col-xs-10 ">'+url+'</div></div>\
    <div class="row buttons nodesktop"><hr><div class="col-sm-12 col-xs-11"><a class="btn btn-default" href="javascript:io_zotero_item_deselect()">Close &nbsp;<em class="fa fa-times"></em></a></div><div class="col-sm-12 col-xs-13 text-right"><a class="btn btn-default btn-primary" href="#'+dataload.key+'">Read more &nbsp;<em class="fa fa-chevron-right"></em></a></div></div>\
	';
	return out;
}
