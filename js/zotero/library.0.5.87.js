...
function io_zotero_item_details(dataload) {
	...
	if(dataload.data.abstractNote != undefined && dataload.data.abstractNote != ''){
		...
		var note = dataload.data.abstractNote;
		if(io_zotero_layout == 'item'){
			note = io_get_urls_in_content(dataload.data.abstractNote);
		}

		abstractNote += '<div class="abstractNote"><div class="text">'+note+'</div><div class="grad"></div><a href="javascript:io_class_toggle(';
