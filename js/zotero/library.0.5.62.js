        ...
        <div class="text">\
            <div class="open_book" id="book-'+dataload.key+'" rel="'+dataload.key+'" onclick="io_zotero_item_click(this)">\
            	...
            	<div class="bg">\
                    ...
                    <div class="footopener"><a href="#'+dataload.key+'" class="btn btn-default rounded">OPEN</a></div>\
                </div>\
            </div>\
        </div>\
    </div>\
...
/*
				...
				if(str){
					...
					if(!io_zotero_search_autocomplete){
						out += abstractNote;
						out += '<a class="btn btn-default rounded" href="#'+io_zotero_arr_obj[key].key+'">Read more &nbsp;<em class="fa fa-chevron-right"></em></a>';
					}
