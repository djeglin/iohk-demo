...
function io_zotero_item_details(dataload) {
    ...
    '+ISBN+'\
    '+abstractNote+'\
    <div class="row buttons"><div class="col-sm-14 col-xs-14"><a class="btn btn-default btn-block rounded" href="#'+dataload.key+'">Read more &nbsp;<em class="fa fa-chevron-right"></em></a></div><div class="col-sm-10 col-xs-10">'+url+'</div></div>\
	';
	return out;
}
