...
function io_intro_init(){
	...
	setTimeout(function(){
        ...
        document.getElementById("intro_theme-1").addEventListener("click", function(){$("#pop-theme").addClass('none');$("#poper-theme .val").text('1');io_intro_animation.updateTheme(0);}); 
        document.getElementById("intro_theme-2").addEventListener("click", function(){$("#pop-theme").addClass('none');$("#poper-theme .val").text('2');io_intro_animation.updateTheme(1);}); 
        document.getElementById("intro_theme-3").addEventListener("click", function(){$("#pop-theme").addClass('none');$("#poper-theme .val").text('3');io_intro_animation.updateTheme(2);}); 
