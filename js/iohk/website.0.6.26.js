...
function io_intro_init(){
	...
	setTimeout(function(){
        ...
        parameters = { 
            'particle_path' : "js/intro.0.4/textures/particle3.png",
            'container_id' : "io_intro",
            'renderer_id' : "io_intro_renderer",
            'stats_id' : "io_intro_stats",
            "gui_id" : "io_intro_gui",
            "electrolized_path" : 'js/intro.0.4/libs/electrolized.js',
            "spec_path1"  : 'js/intro.0.4/textures/spec_body_squared.jpg',
            "spec_path2"  : 'js/intro.0.4/textures/spec_body5.jpg',
            "spec_path3"  : 'js/intro.0.4/textures/spec_line2.jpg',
            "spec_path4"  : 'js/intro.0.4/textures/spec_body11.jpg',
		...
		//here: this is how you use the animation methods to play, pause and stop. Remember that "anima<tion" variable is only valid on this context.
        ...
        document.getElementById("intro_quality-1").addEventListener("click", function(){$("#pop-quality").addClass('none');$("#poper-quality .val").text('Default');io_intro_animation.quality(0);}); 
        document.getElementById("intro_quality-2").addEventListener("click", function(){$("#pop-quality").addClass('none');$("#poper-quality .val").text('Good');io_intro_animation.quality(1);}); 
        document.getElementById("intro_quality-3").addEventListener("click", function(){$("#pop-quality").addClass('none');$("#poper-quality .val").text('Wow');io_intro_animation.quality(2);}); 

        document.getElementById("intro_theme-1").addEventListener("click", function(){$("#pop-theme").addClass('none');$("#poper-theme .val").text('Scorex');io_intro_animation.theme(0);}); 
        document.getElementById("intro_theme-2").addEventListener("click", function(){$("#pop-theme").addClass('none');$("#poper-theme .val").text('Veritas');io_intro_animation.theme(1);}); 
        document.getElementById("intro_theme-3").addEventListener("click", function(){$("#pop-theme").addClass('none');$("#poper-theme .val").text('Serokell');io_intro_animation.theme(2);}); 
...
function io_intro_gui(){
	if(!io_intro_gui_setup){
		...
		$(".intro_nav .colors .swatches").each(function(){
			$(this).append(io_color_swatches());
		});
	}
}
...
function io_color_swatches(){
	var out = '';
	for(var i=0;i<io_color_swatches_arr.length;i++){
		out += '<button type="button" class="swatch rounded" style="background:'+io_color_swatches_arr[i]+'"></button>';
	}
	return out;
}
