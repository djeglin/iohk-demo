...
function io_intro_init(){
	...
	if(ww > 400){
		...
		//jQuery.getScript("/js/intro.0.4.2/libs/three76.min.js", function(){
			//jQuery.getScript("/js/intro.0.4.2/libs/animation.min.js", function(){
...
;(function($) {
	...
	function io_globe(){
		...
		//if(!scripts_loaded){
			//$.getScript("/examples/js/renderers/Projector.js", function(){
							...
							//$.getScript("/js/globe/third-party/Tween.js", function(){
								//$.getScript("/js/globe/marker.js", function(){
									...
									$.getScript("/js/globe/coord.js", function(){
										$.getScript("/js/globe/globe.0.1.js", function(){
											scripts_loaded = true;
