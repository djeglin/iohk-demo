	    ...
	    $parseRSS({
	        ...
	        callback: function (posts) {
	            for(var i=0;i<posts.length;i++){
	                ...
	                $(target).append('<li class="'+cls+'"><a href="'+post.link+'" title="Check this commit on Github" target="_blank">'+tit.trim()+' <small class="block small">'+post.publishedDate.substr(0, (post.publishedDate.length - 5))+' <em>by <b>'+post.author+'</b></em></small></a></li>');
	            }
	        }
	    });
	}
