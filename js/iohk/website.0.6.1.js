...
function io_intro_init(){
	...
	setTimeout(function(){
        ...
        document.getElementById("intro_quality-1").addEventListener("click", function(){$("#pop-quality").addClass('none');io_intro_animation.quality(0);}); 
        document.getElementById("intro_quality-2").addEventListener("click", function(){$("#pop-quality").addClass('none');io_intro_animation.quality(1);}); 
        document.getElementById("intro_quality-3").addEventListener("click", function(){$("#pop-quality").addClass('none');io_intro_animation.quality(2);}); 
...
function io_intro_gui(){
	...
	//},100);
	//io_intro_gui_select("#pop-quality");
	//io_intro_gui_select("#pop-theme");
...
function io_intro_gui_select(div){
